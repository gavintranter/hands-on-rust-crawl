...
impl State {
    ...
    fn victory(&mut self, ctx: &mut BTerm) {
        ...
        ctx.print_color_centered(2, GREEN, BLACK, "Victory");
        ctx.print_color_centered(9, WHITE, BLACK, "Press the numeral 1 to guide the next hero");
    ...
    fn advance_level(&mut self) {
        ...
        <(Entity, &Carried)>::query().iter(&self.ecs)
    ...
    fn game_over(&mut self, ctx: &mut BTerm) {
        ctx.set_active_console(2);
        ctx.print_color_centered(2, RED, BLACK, "Oops");
        ...
        ctx.print_color_centered(8, WHITE, BLACK, "Never fear another hero will be called");
        ctx.print_color_centered(9, WHITE, BLACK, "Press the numeral 1 to guide the next hero");
